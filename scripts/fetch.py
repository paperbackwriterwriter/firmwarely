...
CHANGED_WEEKLY = ROOT / "changed_weekly.json"   # the week's changes, written on the weekly run for free accounts
WEEKLY = ROOT / "weekly_changes.json"   # changes collected since the last weekly email; committed
